...
في أول ثلاث نتائج في PLACEHOLDER_BEFORE، وبالطبقتين معًا صار PLACEHOLDER_AFTER.

- **المتجهات تُحسب هنا لا على الخادم.** نواة ARM واحدة تنجز ~0.25 مستند/ثانية (أربعة أيام ونصف
